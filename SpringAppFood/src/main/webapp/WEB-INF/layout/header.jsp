    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto d-flex flex-row mt-3 mt-lg-0">
        ...
        <sec:authorize access="hasRole('ROLE_ADMIN')">
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/admin/product-post" />">Quản lý sản phẩm </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/admin/category" />">Quản lý danh mục </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/admin/account" />">Quản lý tài khoản  </a>
            </li>

            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/admin/account-permission" />">Duyệt tài khoản nhà hàng</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link text-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Thống kê</a>
        ...
        <sec:authorize access="hasRole('ROLE_NH')">
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/restaurant/restaurant-info/add-or-update" />">Chỉnh sửa thông tin</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/restaurant/post/add-or-update" />">Đăng sản phẩm</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/restaurant/management" />">Quản lý bài viết</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-secondary" href="<c:url value="/restaurant/order" />">Quản lý đơn hàng</a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link text-secondary dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Thống kê</a>
                <ul class="dropdown-menu" >
      ...
      <!-- Search form -->
        ...
        <form method="get" action="${action}" class="d-flex input-group w-auto ms-lg-3 my-3 my-lg-0">
            <input class="form-control me-2" type="search" class="form-control" name="kw" placeholder="Nhập từ khóa để tìm...">
            <button type="submit" class="btn btn-outline-white" type="button" data-mdb-ripple-color="dark"><i class="fa fa-search"></i></button>
        </form>
