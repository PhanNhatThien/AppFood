            ...
            <div class="row">
                <c:forEach items="${products}" var="p">
                    <div class="col-md-3 col-xs-12" style="padding: 10px">
                        <div class="card"">
                            <img class="card-img-top" class="img-fluid" src="https://res.cloudinary.com/dtswvj7fd/image/upload/v1660674849/cld-sample-4.jpg" alt="Card image">
                            <div class="card-body">
