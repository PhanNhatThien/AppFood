...
//                } else if (user.getUserRole().equals(User.NHAHANG)) {
//                    Restaurant restaurant = new Restaurant();
//                    restaurant.setId(0);
//                    restaurant.setName("n/a");
//                    restaurant.setUser(userService.getUserById(user.getId()));
////                    employerService.addOrUpdate(employer);
//
//                    sucMsg = String.format("Thêm thông tin '%s' thành công", user.getUsername());
//                }
//            } else {
